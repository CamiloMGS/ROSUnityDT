...
class Trajectory_Planner_RobotRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type Trajectory_Planner_RobotRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type Trajectory_Planner_RobotRequest
    let len;
    let data = new Trajectory_Planner_RobotRequest(null);
  ...
  static datatype() {
    ...
    return 'ros_unity_robotics/Trajectory_Planner_RobotRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Trajectory_Planner_RobotRequest(null);
...
class Trajectory_Planner_RobotResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type Trajectory_Planner_RobotResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type Trajectory_Planner_RobotResponse
    let len;
    let data = new Trajectory_Planner_RobotResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'ros_unity_robotics/Trajectory_Planner_RobotResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Trajectory_Planner_RobotResponse(null);
...
module.exports = {
  Request: Trajectory_Planner_RobotRequest,
  Response: Trajectory_Planner_RobotResponse,
  md5sum() { return '21c74ee74be8fa8772be222ac6c4b3c3'; },
  datatype() { return 'ros_unity_robotics/Trajectory_Planner_Robot'; }
};
